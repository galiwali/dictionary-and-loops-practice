...
print(len(students))#length of the students
...
#     print(student['LunchStatus':'Reduced'])
#     print("_"*25)
#     if ('GL') >=10:
#         students.update(['Offcampus'])
#         print(student['Offcampus'])
#         print("_"*25)
